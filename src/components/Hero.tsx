        ...
        <div className="flex-1 order-2 md:order-1 text-center md:text-left">
          <ScrollReveal>
            <div className="inline-block mb-4">
              <span className="text-gold text-xs tracking-[0.3em] uppercase border border-gold/30 px-4 py-1.5 rounded-full">
                Portfolio
              </span>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.2}>
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-cream leading-[0.9] tracking-[-0.02em] uppercase mb-4">
              ...
              <br />
              <span className="gold-gradient">{profile.name.split(" ").slice(1).join(" ")}</span>
            </h1>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.6}>
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              <a
                href="#contact"
                className="group relative px-8 py-3 bg-gold text-black text-sm tracking-[0.2em] uppercase font-semibold overflow-hidden rounded-full transition-all duration-300 hover:shadow-[0_0_30px_rgba(212,175,55,0.3)]"
              >
              ...
              <a
                href="#education"
                className="group relative px-8 py-3 border border-gold/30 text-cream text-sm tracking-[0.2em] uppercase overflow-hidden rounded-full transition-all duration-300 hover:border-gold/60"
              >
